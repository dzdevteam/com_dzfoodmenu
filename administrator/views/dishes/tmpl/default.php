...
$canOrder   = $user->authorise('core.edit.state', 'com_dzfoodmenu');
$saveOrder  = $listOrder == 'a.ordering';
if ($saveOrder)
{
    $saveOrderingUrl = 'index.php?option=com_dzfoodmenu&task=dishes.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_dzfoodmenu&view=dishes'); ?>" method="post" name="adminForm" id="adminForm">
...
<?php endif;?>
        ...
        <table class="table table-striped" id="dishList">
            ...
            <?php foreach ($this->items as $i => $item) :
                ...
                $canCreate  = $user->authorise('core.create',       'com_dzfoodmenu');
                $canEdit    = $user->authorise('core.edit',         'com_dzfoodmenu');
                $canCheckin = $user->authorise('core.manage',       'com_dzfoodmenu');
                $canChange  = $user->authorise('core.edit.state',   'com_dzfoodmenu');
                ?>
                ...
                <?php endif; ?>
                <?php if ($canEdit) : ?>
                    <a href="<?php echo JRoute::_('index.php?option=com_dzfoodmenu&task=dish.edit&id='.(int) $item->id); ?>">
                    <?php echo $this->escape($item->title); ?></a>
                <?php else : ?>
                    <?php echo $this->escape($item->title); ?>
                <?php endif; ?>
                    <br />
                    <span class="small"><?php echo JText::_('COM_DZFOODMENU_FORM_LBL_DISH_ALT_TITLE'); ?>: <?php echo $item->alternative['title']; ?>
                </td>
                <td>
